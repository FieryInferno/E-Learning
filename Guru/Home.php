    ...
    <div class="mt-3">
      ...
      <?php 
        ...
        foreach ($roleGuru as $rg) {
          $query_daftar_pesan = mysqli_query($con, "SELECT P.*, M.nis, M.nama_siswa,M.foto,M.id_kelas,M.id_jurusan FROM pesan P, tb_siswa M WHERE P.id_pengirim=M.nis AND P.id_penerima='$data[nik]' AND P.id_kelas='$rg[id_kelas]' ORDER BY P.id_pesan DESC");
                        ...
                        <form action="" method="post">
                          <div class="modal-body"> 
                            ...
                            <div class="form-group">
                              ...
                              <textarea name="isi_pesan" class="form-control" rows="5" placeholder="Tulis Pesan"></textarea>
                            </div>
                          ...
                          <div class="modal-footer">
                            ...
                            <?php 
                              if (isset($_POST['sendMassage'])) {
                                $tanggal  = date('Y-m-d');
                                $send     = mysqli_query($con, "INSERT INTO pesan VALUES('null', '$_POST[pengirim]', '$_POST[penerima]', '$tanggal', 'Re: $_POST[isi_pesan]', 'belum', '$_POST[kelas]')");
                                if ($send) {
        ...
        <form action="" method="post">
          ...
          <div class="form-group">
            ...
            <textarea name="pesan" class="form-control" rows="5" placeholder="Tulis Pesan"></textarea>
          </div>
            <div class="form-group">
        ...
        <?php 
          if (isset($_POST['sendMassageMassal'])) {
            $tanggal  = date('Y-m-d');
            $send     = mysqli_query($con, "INSERT INTO pesan VALUES('null', '$_POST[idpengirim]', '$_POST[penerima]', '$tanggal', '$_POST[pesan]', 'belum', '$_POST[idkelas]')");
            if ($send) {
              echo "
              <script> 
                alert('Terkirim !');
