                        ...
                        <?php 
                          ...
                          foreach ($sqlrole as $row) { ?>  
                            <tr>
                              ...
                              ?>
                            <b><?=$nokelas++;?> .</b> <a href="?page=nilai&act=view&ujian=<?=$l['id_ujian']; ?>&kelas=<?=$l['id_kelas']; ?>&" class='btn btn-info text-white'><i class='fa fa-server'></i> <?php echo $l['kelas']; ?> -  <?php echo $l['jurusan']; ?>  (<?php echo $jmlsiswa; ?>)</a> 
                           <br>
                            <br>  
                            <?php 
                        }
