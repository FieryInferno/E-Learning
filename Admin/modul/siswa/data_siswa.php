                      ...
                      <tr>
                        ...
                        <td>
                          <?php
                            switch ($d['confirm']) {
                              case 'Yes': ?>
                                <a href="?page=siswa&act=unconfirm&id=<?=$d['id_siswa']?>" class="btn btn-warning btn-xs"><i class="fa fa-times"></i> Batal Konfirmasi</a>
                                <?php break;
                              case 'No': ?>
                                <a href="?page=siswa&act=confirm&id=<?=$d['id_siswa']?>" class="btn btn-success btn-xs"><i class="fa fa-check"></i> Konfirmasi</a>
                                <?php break;
