<?php
  ...
  if (@$_SESSION['Siswa']) {
    ...
    <head>
      ...
      <link rel="shortcut icon" href="../assets/img/logo_kecil.png" />
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                  <a href="?page=materi" class="dropdown-item">
                    <p class="mb-0 font-weight-normal float-left"><b><?=$jmlh; ?></b> Mata Pelajaran</p>
        ...
        <div class="container-fluid page-body-wrapper">
          ...
          <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
              ...
              <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#menuMateri" aria-expanded="false" aria-controls="general-pages"> <img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <span class="menu-title">MATERI</span><i class="menu-arrow"></i></a>
              ...
              <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#menuEvaluasi" aria-expanded="false" aria-controls="general-pages"> <img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <span class="menu-title">EVALUASI</span><i class="menu-arrow"></i></a>
              ...
              <li class="nav-item purchase-button">
                <a class="btn-grad" href="logout.php?ID=<?php echo $data['id_siswa'] ?>">Logout</a>
              </li>
            </ul>
          </nav>
          <!-- partial -->
            ...
            <?php
              ...
              if ($page=='materi') {
                ...
                <div class="content-wrapper">
                  <h3> <b>Dashboard</b> <small class="text-muted">/Siswa</small></h3>
                  <hr>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="card">
