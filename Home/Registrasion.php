...
<html lang="en">
  ...
  <body>
    <div class="limiter">
      <div class="container-login100" style="background-color: #082A9C;">
        <img src="../assets/img/logo_jicsi.png" alt="" width="40%" class="pr-5">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
          <form action="" method="post" class="login100-form validate-form">
            <span class="login100-form-title p-b-49">
              <h2>REGISTER</h2>
              <p class="text-danger">Pendaftaran Akun Siswa</p>
            </span>
            ...
            <div class="wrap-input100 validate-input m-b-23" data-validate = "nama harus di isi">
              <span for="nama" class="label-input100 text-danger">Username</span>
          ...
          if (isset($_POST['Registrasi'])) {
            ...
            if ($password!=$confirmasi) {
              ...
              if ($level==1) {
                ...
                $sqlSiswa = mysqli_query($con,"INSERT INTO tb_siswa VALUES(NULL,'$no','$namaUser', '$username', '$_POST[jk]', '$password', 'off', 'N', '0', 'default.png', '$_POST[kelas]', NULL, 'No')") or die(mysqli_erro($con));
                if ($sqlSiswa) {
                  echo "
                  <script type='text/javascript'>
                    setTimeout(function () {
